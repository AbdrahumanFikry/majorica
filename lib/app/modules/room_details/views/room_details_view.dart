  ...
  Widget build(BuildContext context) {
    return GlobalScaffold(
      body: Obx(
        () {
          final images =
              controller.roomData.value?.images?.toList() ?? <String>[];
          return Stack(
            children: [
              SizedBox(
                height: Get.height,
                ...
                child: SafeArea(
                  child: AnimatedListHandler(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () => Get.to(
                          () => RoomImagesView(galleryItems: images),
                        ),
                        child: Container(
                      ...
                      RoomMainData(),
                      RoomDescription(),
                      if (controller.roomPackagesFromCache.isNotEmpty)
                        RoomPackages(),
                      RoomParticipants(),
                      RoomCount(),
                      AppButton(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              '${controller.total ?? '-'} ${S.of(context).egp}',
                              style: AppUtil.textStyle(
                                fontSize: 60.sp,
                                color: ColorUtil.whiteColor,
                                fontWeight: FontWeight.w600,
